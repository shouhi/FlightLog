...
class Const {
  static String progAcLogo =
      'https://www.prog-ac.com/wp-content/uploads/2020/07/cropped-prog-ac-logo.png';
  static String progAcBlogURL = 'https://prog-ac.hatenablog.com/';
  ...
  static const utilTextStyle = {
    "kBodyText": const TextStyle(fontSize: 22, color: Colors.white, height: 1.5)
  };
}
